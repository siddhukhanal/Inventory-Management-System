"use client"
import { Archive, CircleDollarSign, Clipboard, Layout, LucideIcon, Menu, Settings, SlidersHorizontal, Users } from 'lucide-react'
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5":"px-8"}`}>
        <div>Logo</div>
        <h1 className={`${isSidebarCollapsed ? "hidden":"block"} font-extrabold text-2xl`}> Mike
      ...
      >
        ...
        <div className={`${isSidebarCollapsed ? "hidden":"block"} mb-10`}>
            <p className="text-center text-xs text-gray-500">&copy; 2026 Vivaan Collections</p>
        </div>
